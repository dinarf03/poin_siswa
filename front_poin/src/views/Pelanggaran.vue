      ...
      <template v-slot:modal-title>
        ...
        <form ref="form">
          <div class="form-group">
            ...
            <input type="text" name="nama_pelanggaran" class="form-control" id="nama_pelanggaran" placeholder="Nama Pelanggaran" v-model="nama_pelanggaran">
          </div>
          <div class="form-group">
            <label for="kategori" class="col-form-label">Kategori</label>
            <select class="form-control" name="kategori" id="kategori" v-model="kategori">
              <option value="kedisiplinan">Kedisiplianan</option>
          ...
          <div class="form-group">
            ...
            <input type="text" name="poin" class="form-control" id="poin" placeholder="Poin" v-model="poin">
          </div>
        </form>
    </b-modal>
